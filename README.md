...
- LaTeX 编译中间文件
- 生成的 PDF
- 学校 Word 模板解压目录 `docx_extracted/`
- 原始 Word 模板 `.docx`
- 上交模板参考目录 `SJTUThesis-full-2.3.1/`

这样做的目的是让版本控制只聚焦在“昆工模板本体”，避免仓库被编译产物和参考资料撑大。
...
本仓库目前主要用于模板开发与校内论文排版实践。若后续公开发布，建议在正式版本中补充明确的许可证说明、使用边界和引用方式。
